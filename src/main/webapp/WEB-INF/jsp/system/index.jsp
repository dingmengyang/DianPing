...
<form method="post" action="${basePath}/login" id="mainForm">
    <input type="hidden" name="_method" value="DELETE"/>
    <div id="header">
        <div class="iheader">
            <div class="logo"><a href="#"><imgFileName src="/upload/ad/rubbit.jpg" alt="" height="88px" width="99px"/></a> </div>
            <div style="height: 44px;">
                <div class="wuxianlogo"><imgFileName src="" alt="" height="28px" width="275px"/></div>
                <div class="h_info">
            ...
            <ul class="nav" id="mainMenuUI">
                <li onclick="clickMenu(this,'mainMenuUI')" class=""><a><span>系统管理</span></a></li>
                <li onclick="clickMenu(this,'mainMenuUI')" class=""><a><span>内容管理</span></a></li>
                <li onclick="clickMenu(this,'mainMenuUI')" class=""><a><span>统计报表</span></a></li>
            </ul>
        </div>
    </div>
    <div id="container">
                ...
                <td class="leftTd" style="vertical-align:top" width="150">
                    <div class="left">
                        <div class="ileft" id="subMenuDiv">
                            ...
                            <h3 onclick="clickSubMenu(this,'businesses')"><a>商家管理</a></h3>
                            <h3 onclick="clickSubMenu(this,'orders')"><a>订单列表</a></h3>
                            <h3 onclick="clickSubMenu(this,'comment')"><a>评价列表</a></h3>
                        </div>
                    </div>
                </td>
                <td width="7">
